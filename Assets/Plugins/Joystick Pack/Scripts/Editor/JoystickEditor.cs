...
public class JoystickEditor : Editor
{
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(changeColor, new GUIContent("Change Color", "Whether to change the color of the joystick."));
        if (changeColor.boolValue)
        {
            EditorGUILayout.PropertyField(normalColor, new GUIContent("Normal Color", "The normal color of the joystick."));
            EditorGUILayout.PropertyField(maxColor, new GUIContent("Max Color", "The max color of the joystick."));
        }
    }
